...
export const GRADE6_SEMESTER2_UNITS = [
  ...
  {
    id: 'g6s2-unit3',
    // 자료에 "매체단원"으로만 적혀 있어 단원 번호는 3으로 가정했다.
    unitNumber: 3,
    icon: '📱',
    title: '매체 성찰 보고서 쓰기',
    ...
    chunks: [
      {
        ...
        criteria: [
          ...
          },
          {
            ...
            assessmentNotes: [
              'usage-pattern은 시간, 횟수, 상황, 상황별 행동 가운데 하나라도 함께 드러나면 met이야. 숫자가 반드시 있어야 하는 것은 아니야.',
            ],
          },
          {
            id: 'felt-point',
      ...
      },
      {
        ...
        criteria: [
          ...
          },
          {
            ...
            assessmentNotes: [
              'five-w-one-h는 전문만 보고 판정해. 본문에만 있는 요소는 세지 마.',
