...
**기준:** 2026-07-11, Phase 1(Next.js/DB/인증 전환) + Phase 2(교사 학생별 성장 과정 보기) + 제출하기 기능 제거 + 교사 화면 넓은 레이아웃 + master 병합/Vercel 배포 전환 + Phase 4 전체(무의미한 글/스페이스 가드 + AI 2차 판단 + 욕설/비속어 교사 승인 큐) 완료 시점 — `master` 브랜치
